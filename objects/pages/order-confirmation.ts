...
export class OrderConfirmationPage {
    ...
    constructor(page: Page) {
        this.page = page;
        this.reservationSummaryHeading = page.getByRole('heading', { name: 'Reservation Summary' });
        this.printBookingButton = page.getByRole('button', { name: 'Print Booking' });
        ...
        this.cardMaskedValue = page.getByTestId('booking-confirmation-Card-0').locator('span');
        this.propertyInformationText = page.getByText('Property Information');
        this.homeOutlinedIcon = page.getByTestId('HomeOutlinedIcon');
        this.danielLakeyQATestingLink = page.getByRole('link', { name: 'Daniel Lakey QA Testing' });
    }
    ...
    async assertReservationDates(durationText: string, checkInDate: string, checkOutDate: string) {
