...
export class CartPage {
  ...
  constructor(page: Page) {
    ...
    this.addressFinderTextbox = page.getByRole('textbox', { name: 'Address Finder' });
    ...
    this.nameOnCardTextbox = page.getByRole('textbox', { name: 'Name on card' });
    ...
    this.expiryFrame = page.frameLocator('iframe[title="Iframe for expiry date"]');
    this.cvvFrame = page.frameLocator('iframe[title="Iframe for security code"]');
    this.cardNumberTextbox = this.cardNumberFrame.getByRole('textbox', { name: 'Card number' });
    this.expiryDateTextbox = this.expiryFrame.getByRole('textbox', { name: 'Expiry date' });
    this.securityCodeTextbox = this.cvvFrame.getByRole('textbox', { name: 'Security code' });
  }
  ...
  async selectDateOfBirth() {
    ...
    await this.page.getByRole('button', { name: 'Saturday, January 1,' }).click();
  }
