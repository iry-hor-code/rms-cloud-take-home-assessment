...
export class HomePage {
    ...
    constructor(page: Page) {
        ...
        this.guestSelectorPlusButton = page.getByTestId('guest-selector-plusButton-children');
        ...
        this.firstSeePricesButton = page.getByTestId('see-prices-btn-rates-page').first();
        this.firstAddToCartButton = page.getByTestId('add-to-cart-btn-rates-page').first();
        this.firstPricesContainerSeePricesButton = page.getByTestId('see-prices-container').first().getByTestId('see-prices-btn-rates-page');
